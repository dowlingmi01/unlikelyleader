export type ArchetypePageContent = {
  name: string;
  description: string;
  videoUrl?: string;
  photoUrl?: string;
...
export const ARCHETYPE_PAGE_CONTENT: Record<string, ArchetypePageContent> = {
  'steady-anchor': {
    name: 'Steady Anchor',
...
export const ARCHETYPE_SLUGS = Object.keys(ARCHETYPE_PAGE_CONTENT);

export function getArchetypePageContent(slug: string): ArchetypePageContent | undefined {
  return ARCHETYPE_PAGE_CONTENT[slug];
}
